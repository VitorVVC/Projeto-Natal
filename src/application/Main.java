...
public class Main {
    public static void main(String[] args) {
        ...
        Materias geografiaEstela = new Materias(MateriasEnum.GEOGRAFIA, 10.0, 7.0);
        Materias historiaEstela = new Materias(MateriasEnum.MATEMATICA, 8.5, 6.0);
        Materias matematicaEstela = new Materias(MateriasEnum.CIENCIA, 10.0, 8.0);
        ...
        Materias inglesEstela = new Materias(MateriasEnum.INGLES, 5.0, 4.0);
        Materias portuguesEstela = new Materias(MateriasEnum.PORTUGUES, 6.5, 6.0);
        Materias redacaoEstela = new Materias(MateriasEnum.REDACAO, 7.0, 8.0);
